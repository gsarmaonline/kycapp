-- Restore the view without the inheritance branch before dropping the table it
-- reads, or the view would be left referencing something that is gone.
...
DROP INDEX IF EXISTS role_extends_parent_idx;
DROP TABLE IF EXISTS role_extends;
